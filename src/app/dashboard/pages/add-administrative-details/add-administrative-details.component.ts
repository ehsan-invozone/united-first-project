...
@Component({
  selector: 'app-add-administrative-details',
  templateUrl: './add-administrative-details.component.html',
  styleUrls: ['./add-administrative-details.component.scss']
})
export class AddAdministrativeDetailsComponent implements OnInit {
