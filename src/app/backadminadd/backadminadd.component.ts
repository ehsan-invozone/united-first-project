...
@Component({
  selector: 'app-backadminadd',
  templateUrl: './backadminadd.component.html',
  styleUrls: ['./backadminadd.component.scss']
})
export class BackadminaddComponent implements OnInit {
