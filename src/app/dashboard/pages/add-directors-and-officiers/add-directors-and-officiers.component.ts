...
@Component({
  selector: 'app-add-directors-and-officiers',
  templateUrl: './add-directors-and-officiers.component.html',
  styleUrls: ['./add-directors-and-officiers.component.scss']
})
export class AddDirectorsAndOfficiersComponent implements OnInit {
  spachecks: any;
